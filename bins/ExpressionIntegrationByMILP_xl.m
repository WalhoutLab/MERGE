function [OpenGene, OpenedHReaction,ClosedLReaction,solution, MILPproblem] = ExpressionIntegrationByMILP_xl(model, RHNames, RLNames,HGeneList,epsilon_f, epsilon_r, alpha, atpm_name,ATPtargetRxns, tol, core, logfile, runtime)
...
c = [c_v;c_yh1;c_yl;c_yh2;c_atp;c_gene];
MILPproblem.c = c;
