...
S,rxns,metabolites,lb,ub,byproducts=loadVarsFromFilenames('./../3_FPA/distance_inputs/Smatrix_regular.txt',\
'./../3_FPA/distance_inputs/reactions_regular.txt','./../3_FPA/distance_inputs/metabolites_regular.txt','./../3_FPA/distance_inputs/LB_regular.txt',\
'./../3_FPA/distance_inputs/UB_regular.txt','./../3_FPA/distance_inputs/byproducts_regular.txt',delimiterInSmatrix=',');
