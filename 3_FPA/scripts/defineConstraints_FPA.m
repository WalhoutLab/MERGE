function model = defineConstraints_FPA(model, infDefault,smallFluxDefault)
...
% USAGE:
%
%    model = defineConstraints_FPA(model, infDefault,smallFluxDefault)
%
% INPUTS:
...
% blood circulation, we use a set of artificial constraints. The constriants
