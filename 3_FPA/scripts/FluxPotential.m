function [fluxEfficiency,fluxEfficiency_plus] = FluxPotential(model,targetRxns,master_expression,distMat,labels,n,manualPenalty,manualDist,maxDist,blockList, constantPenalty,parforFlag,penalty_defined)
%%
if (nargin < 6)
    n = 1.5;
end
